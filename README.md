...
10. SIMPLE STRUCTURES: The code is process is very linear and nested. Annotated and commented throughout for clarity. This code is for others to use so we must always code for the next programmer not just for ourselves.
